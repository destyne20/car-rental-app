    ...
    return (
        <section id="choose">
            <div className="row choose__row">
                <figure className="choose__image__wrapper">
                ...
                <div className="choose__features">
                    <ChooseFeature image={Choose1} title="Cross Country Drive"paragraph="Take your driving experience to the next level with our top-notch vehicles for your cross-country adventures."/>
                    <ChooseFeature image={Choose2} title="All Inclusive Pricing" paragraph="Get everything you need in one convenient, transparent price with our all-inclusive pricing policy."/>
                    <ChooseFeature image={Choose3} title="No Hidden Charges"paragraph="Enjoy peace of mind with our no hidden charges policy. We believe in transparent and honest pricing."/>
                </div>
                </div>
            </div>
        </section>
